...
class Student(usermodel):
	...
	sgpa = models.CharField(max_length=200, default="9.9")
	...
	# grades=models.ManyToManyField(Grades,null=True)
...
class Grades(models.Model):
	...
	grade=models.CharField(default="EX",max_length=255)
	# sem=models.IntegerField(default=1)
	def __str__(self):
		return self.grade+" "+self.course.name
